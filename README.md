...
Finally, I developed a Random Forest Model incorporating test-train and GridsearchCV for cross validation, in order to predict speeds. The features are: location of detector, time of day, day of week and collision rate, with correlation coefficient ~ 0.8.
